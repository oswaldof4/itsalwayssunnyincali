...
metadata_df <- read_csv(here::here("data", "plant_metadata.csv")) %>% 
  filter(PrimeMoverDesc == "Photovoltaic")
...
# note that there are a 19 entries with energy_source_category not equal to "SUN" but prime_mover_id equal to "PV"
# The net MWh is key - incorporates energy source differences
