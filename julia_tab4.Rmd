...
total_out_of_solar_state <- solar_by_state %>% 
  ...
  mutate(total_out_of_solar = (solar_thermal_and_photovoltaic / total)) %>%
...
ggplot(data = total_out_of_solar_state, 
       aes(x = year, 
           y = total_out_of_solar)) +
