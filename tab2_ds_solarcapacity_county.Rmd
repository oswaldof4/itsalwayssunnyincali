...
# Fix plotly hover text issue # For whatever reason, names of plants are ordered in alphabetical order # Try fct reorder
# Adjust plotly hover text to look nicer

# Also total numbers do not match SEIA. Look into why this might be
