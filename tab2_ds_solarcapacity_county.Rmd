...
solar_capacity_plot <- ggplot(data = solar_capacity_df,
  ...
  labs(title = "Solar capacity (2008-2018)",
       ...
       x = "Year",
       y = "Cumulative capacity installed (kW)") +
...
# Fix plotly hover text issue # For whatever reason, names of plants are ordered in alphabetical order
...
```{r}
# -------------
# % of total California solar capacity
# -------------
